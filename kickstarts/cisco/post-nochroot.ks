...
cp -f /run/install/repo/EXTRAS/default-cisco /mnt/sysimage/EDCOP/pxe/pxelinux.cfg/default
cp -f /run/install/repo/EXTRAS/firstboot/firstboot-cisco.sh /mnt/sysimage/root/firstboot.sh
