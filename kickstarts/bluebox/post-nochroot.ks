...
cp -f /run/install/repo/EXTRAS/default-bluebox /mnt/sysimage/EDCOP/pxe/pxelinux.cfg/default
cp -f /run/install/repo/EXTRAS/firstboot/firstboot-bluebox.sh /mnt/sysimage/root/firstboot.sh
